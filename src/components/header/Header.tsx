      ...
      <div className="w-[90%] max-w-[1550px] m-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          <Link
            ...
            } font-normal text-[16px] text-[#3d3d3d] hover:text-[#46A358] transition-all`}
          >
            Home
          </Link>
          <Link
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <button
            ...
            className="bg-[#46a358] flex items-center gap-2 hover:bg-[#3d8f4d] hover:-translate-y-[1px] hover:shadow-md transition-all duration-200 rounded-md cursor-pointer font-medium text-base text-white p-[7px_25px]"
          >
            {isAuth && user ? (
              <>
                <User size={18} />
